...
//     0x2e, 0x00, 0xc1
// };
// static esp_err_t bmi270_register_read(uint8_t reg_addr, uint8_t *data, size_t len)
// {
//     return i2c_master_write_read_device(I2C_MASTER_NUM, BMI270_I2C_ADDRESS, &reg_addr, 1, data, len, I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);
// }

// /**
//  * @brief Write a byte to a bmi270 sensor register
//  */
// static esp_err_t bmi270_register_write_byte(uint8_t reg_addr, uint8_t data)
// {
//     esp_err_t ret;
//     uint8_t write_buf[2] = {reg_addr, data};

//     ret = i2c_master_write_to_device(I2C_MASTER_NUM, BMI270_I2C_ADDRESS, write_buf, sizeof(write_buf), I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS);

//     return ret;
// }
// static esp_err_t bmi270_soft_reset(void)
// {
//     esp_err_t ret;
//     ret = bmi270_register_write_byte(0x7E,0xb6);
//     vTaskDelay(10 / portTICK_PERIOD_MS);
//     return ret;
// }
// static esp_err_t bmi270_connect_test(void)
// {
//     uint8_t data =0;
//     esp_err_t ret;
//     ret = bmi270_register_read(0x00,&data,1);
//     if (data != 0x24) {
//         ESP_LOGE(TAG,"bmi270_connect_fail!");
//         return ESP_FAIL; 
//     }
//     bmi270_register_write_byte(0x7c,0x00);
//     return ret;

// }
// static esp_err_t bmi270_init_data(void)
// {
//     esp_err_t ret;
//     bmi270_register_write_byte(0x59,0x00);
//     ret = i2c_master_write_to_device(I2C_MASTER_NUM, BMI270_I2C_ADDRESS, bmi270_config_file, 
//                     sizeof(bmi270_config_file), I2C_MASTER_TIMEOUT_MS / portTICK_PERIOD_MS); 
//     bmi270_register_write_byte(0x59,0x01);
//     return ret;
// }
// static esp_err_t bmi270_set_performance_mode(void)
// {
//     esp_err_t ret;
//     bmi270_register_write_byte(0x7D,0x0E);
//     bmi270_register_write_byte(0x40,0xA8);
//     bmi270_register_write_byte(0x42,0xE9);
//     ret = bmi270_register_write_byte(0x7C,0x02);
//     return ret;
// }
// static esp_err_t bmi270_set_normal_mode(void)
// {
//     esp_err_t ret;
//     bmi270_register_write_byte(0x7D,0x0E);
//     bmi270_register_write_byte(0x40,0xA8);
...
//     return ret;
// }
// static esp_err_t bmi270_set_powersave_mode(void)
// {
//     esp_err_t ret;
//     bmi270_register_write_byte(0x7D,0x04);
//     bmi270_register_write_byte(0x40,0x17);
//     ret = bmi270_register_write_byte(0x7c,0x03);
//     return ret;
// }
...
//         reg[0] = 0x21;
//         i2c_master_write_read_device(I2C_MASTER_NUM, 0x68, reg, 
//                     1,data,1, 1000 / portTICK_PERIOD_MS);  
//         ESP_LOGI(TAG,"21 %x",data[0]);  
        
//         reg[0] = 0x03;
//         i2c_master_write_read_device(I2C_MASTER_NUM, 0x68, reg, 
//                     1,data,1, 1000 / portTICK_PERIOD_MS);  
//         ESP_LOGI(TAG,"statu %x",data[0]);  

//         reg[0] = 0x0c;
//         i2c_master_write_read_device(I2C_MASTER_NUM, BMI270_I2C_ADDRESS,reg,1, 
...
// }
// esp_err_t bmi270_get_gyro_value(bmi270_value_t *value)
// {
//     uint8_t reg = 0x12;
//     uint8_t data[6];
//     i2c_master_write_read_device(I2C_MASTER_NUM, BMI270_I2C_ADDRESS,&reg,1,data,6, 1000 / portTICK_PERIOD_MS);
//     value->x = (int16_t)(data[5]<<8 |data[4]);
//     value->y = (int16_t)(data[3]<<8 |data[2]);
//     value->z = (int16_t)(data[1]<<8 |data[0]);
//     return ESP_OK;
// }
// esp_err_t bmi270_get_acce_value(bmi270_value_t *value)
// {
//     uint8_t reg = 0x0c;
//     uint8_t data[6];
//     i2c_master_write_read_device(I2C_MASTER_NUM, BMI270_I2C_ADDRESS,&reg,1,data,6, 1000 / portTICK_PERIOD_MS);
...
//     return ESP_OK;
// }
// // esp_err_t bmi270_complimentory_filter(icm42670_handle_t sensor, const icm42670_value_t *const acce_value,
// //                                         const icm42670_value_t *const gyro_value,const icm42670_value_t *const gyro_value_cal,
...
// //     gettimeofday(sens->timer, NULL);
// //     // ESP_LOGI(TAG, "dt = %f", sens->dt);
// //     acce_angle[0] = (atan2(acce_value->y, acce_value->z) * RAD_TO_DEG);
// //     acce_angle[1] = (atan2(acce_value->x, acce_value->z) * RAD_TO_DEG);

// //     gyro_rate[0] = gyro_value->x - gyro_value_cal->x;
// //     gyro_rate[1] = gyro_value->y - gyro_value_cal->y;
...
// //     return ESP_OK;
// // }
// esp_err_t bmi270_calibrate_gyro(bmi270_value_t *const gyro_value_cal)
// { 
//     float acce_angle[2];
//     float gyro_angle[2];
//     gyro_value_cal->x = 0;
...
//         bmi270_value_t value_before;
//         bmi270_get_gyro_value(&value_before);
//         gyro_value_cal->x+=value_before.x;
//         gyro_value_cal->y+=value_before.y;
//         gyro_value_cal->z+=value_before.z;
//     }
//     gyro_value_cal->x = gyro_value_cal->x/1000;
//     gyro_value_cal->y = gyro_value_cal->y/1000;
//     gyro_value_cal->z = gyro_value_cal->z/1000;
//     ESP_LOGI(TAG, "bmi270_calibrate_gyro x = %f, y = %f, z = %f",gyro_value_cal->x,gyro_value_cal->y,gyro_value_cal->z);
//     return ESP_OK;
// }
...
//     bmi270_connect_test();
//     bmi270_init_data();
//     bmi270_set_performance_mode();
//     vTaskDelay(pdMS_TO_TICKS(200));
//     bmi270_register_read(0x21,reg,1);
//     ESP_LOGI(TAG,"init_status %s",reg[0]?"ok":"fail");
//     xTaskCreatePinnedToCore(bmi270_Task, "bmi270_Task", 3 * 1024, NULL, 6, NULL, 0);
//     return ESP_OK;
// }
