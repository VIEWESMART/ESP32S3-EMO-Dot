...
void ui_measuing_screen_init(void)
{
    ...
    lv_img_set_src(ui_comp_get_child(ui_pulse_group3, UI_COMP_PULSEGROUP_HEART), &ui_img_flash_png);
    lv_img_set_zoom(ui_comp_get_child(ui_pulse_group3, UI_COMP_PULSEGROUP_HEART), 400);

    lv_label_set_text(ui_comp_get_child(ui_pulse_group3, UI_COMP_PULSEGROUP_BPM), "%");
    ...
    lv_label_set_text(ui_measuring, "Charging...");
