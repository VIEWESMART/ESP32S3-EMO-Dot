...
class EMO_DOT_1_8 : public WifiBoard {
private:
    ...
    static void touch_event_task(void* arg)
    {
        ...
        while (true) {
            if (touchpad->WaitForTouchEvent()) {
                ...
                auto &board = (EMO_DOT_1_8 &)Board::GetInstance();
    ...
    void InitializeCst816sTouchPad()
    {
        ...
        gpio_isr_handler_add(TP_PIN_NUM_INT, EMO_DOT_1_8::touch_isr_callback, cst816s_);
    }
...
public:
    EMO_DOT_1_8() : boot_button_(BOOT_BUTTON_GPIO)
    {
        InitializeI2c();
        InitializeCst816sTouchPad();

        InitializeSpi();
        Initializest77916Display(0);
        InitializeButtons();
